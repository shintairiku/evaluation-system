...
- [ ] **3.1. goals.ts サーバーアクションの修正**
  > 直接HTTPクライアント使用からendpoints経由のパターンに変更。
  >
  > **関連要件:** 1.1, 1.2

- [ ] **3.2. goals.ts エンドポイントファイルの作成**
...
- [ ] **4.1. departments.ts サーバーアクションの作成**
  > Department用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.2. roles.ts サーバーアクションの作成**
  > Role用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.3. stages.ts サーバーアクションの作成**
  > Stage用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.4. evaluation-periods.ts サーバーアクションの作成**
  > EvaluationPeriod用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.5. self-assessments.ts サーバーアクションの作成**
  > SelfAssessment用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.6. supervisor-reviews.ts サーバーアクションの作成**
  > SupervisorReview用の標準化されたサーバーアクションを実装。
  >
  > **関連要件:** 3.1, 3.2

- [ ] **4.7. supervisor-feedbacks.ts サーバーアクションの作成**
